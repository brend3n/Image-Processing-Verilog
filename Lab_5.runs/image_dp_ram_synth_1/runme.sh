...
HD_PWD='C:/Users/Brenden Morton/Desktop/TopDesk/UCF/Grad/FPGA/Lab_5/Lab_5.runs/image_dp_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_dp_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_dp_ram.tcl
